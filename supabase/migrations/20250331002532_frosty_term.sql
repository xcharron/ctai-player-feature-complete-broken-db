/*
  ...
  1. Changes
    ...
    - Update user creation trigger to handle metadata correctly
    - Add proper indexes for performance
    - Fix email verification handling
...
-- Create function to handle new user creation with proper metadata handling
...
BEGIN
  ...
  IF raw_first_name = '' OR raw_last_name = '' OR raw_phone = '' THEN
    RAISE EXCEPTION 'Missing required user metadata (first_name, last_name, or phone)';
  END IF;
